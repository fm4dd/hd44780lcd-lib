/***************************************************************************/
/* RABBIT_RCM4010_TO_HD44780LCD_EXAMPLE5.C   http://www.frank4dd.com/howto */
/*                                                                         */
...
/* using a 20x4 LCD (i.e. a Optrex NFQJ-LG-ACN module).                    */
/*                                                       Frank4dd, @2009   */
/***************************************************************************/
#class auto
...
#define DISPLAYSIZE 20                       // The length of the LCD display
...
void LcdWriteStr(int line, char s[]) {
  ...
  if (line == 2) LcdCommandWr(0xC0);         // Set display address for line 2
  if (line == 3) LcdCommandWr(0x94);         // Set display address for line 3
  if (line == 4) LcdCommandWr(0xD4);         // Set display address for line 4
...
void main() {
  ...
  LcdWriteStr(1,"Rabbit-RCM4010: 123");
  pause(5);
